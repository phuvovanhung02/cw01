...
public class ResidentAdapter extends RecyclerView.Adapter<ResidentAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.listItemResidentDescription.setText(resident.getDescription());
        holder.listItemResidentUsername.setText(resident.getUsername());
        holder.listItemResidentNumber.setText(resident.getNumber());
        holder.listItemResidentStartDate.setText(resident.getStartDate());
        holder.listItemResidentRisk.setText(resident.getRequiresRisk() == 1 ? owner : tenant);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        protected TextView listItemResidentName, listItemResidentStartDate, listItemResidentRisk,
                listItemResidentDestination,listItemResidentDescription,listItemResidentUsername,listItemResidentNumber;
        ...
        public ViewHolder(View itemView) {
            ...
            listItemResidentDescription = itemView.findViewById(R.id.listItemResidentDescription);
            listItemResidentUsername = itemView.findViewById(R.id.listItemResidentUsername);
            ...
            listItemResidentRisk = itemView.findViewById(R.id.listItemResidentRisk);
