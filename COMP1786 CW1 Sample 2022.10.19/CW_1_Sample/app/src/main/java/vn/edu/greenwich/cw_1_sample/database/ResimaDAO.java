...
public class ResimaDAO {
    ...
    public ArrayList<Resident> getResidentList(Resident resident, String orderByColumn, boolean isDesc) {
        ...
        if (null != resident) {
            ...
            if (resident.getUsername() != null && !resident.getUsername().trim().isEmpty()) {
                selection += " AND " + ResidentEntry.COL_USER_NAME + " = ?";
                conditionList.add(resident.getUsername());
            }
            if (resident.getNumber() != null && !resident.getNumber().trim().isEmpty()) {
                selection += " AND " + ResidentEntry.COL_NUMBER_OF_PASSENGER + " = ?";
                conditionList.add(resident.getNumber());
            }
    ...
    protected ContentValues getResidentValues(Resident resident) {
        ...
        values.put(ResidentEntry.COL_USER_NAME, resident.getUsername());
        values.put(ResidentEntry.COL_NUMBER_OF_PASSENGER, resident.getNumber());
    ...
    protected ArrayList<Resident> getResidentFromDB(String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String orderBy) {
        ...
        while (cursor.moveToNext()) {
            ...
            residentItem.setUsername(cursor.getString(cursor.getColumnIndexOrThrow(ResidentEntry.COL_USER_NAME)));
            residentItem.setNumber(cursor.getString(cursor.getColumnIndexOrThrow(ResidentEntry.COL_NUMBER_OF_PASSENGER)));
